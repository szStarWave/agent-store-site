const zhCN = {
  ...
  landing: {
    ...
    showcase: {
      ...
      views: {
        chat: { label: "会话", desc: "思考过程、工具调用与回复在同一条时间线上" },
        experts: { label: "专家", desc: "按场景挑选专家与专家团，一键添加" },
        skills: { label: "技能", desc: "按名称或来源检索，管理已安装项" },
        connectors: { label: "连接器", desc: "外部系统接入与凭据状态一览" },
        settings: { label: "设置", desc: "主题、语言与 App Server 连接" },
      },
      zoom: "点击放大",
      close: "关闭",
    },
