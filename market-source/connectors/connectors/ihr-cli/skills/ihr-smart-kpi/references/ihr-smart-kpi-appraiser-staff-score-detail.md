# `ihr-cli smart-kpi appraiser +staff-score-detail`

员工绩效评估人评分明细。完整筛选字段见 [SMART-KPI 报表查询](ihr-smart-kpi-reports.md)。
...
- 批量执行：`ENFORCED`；最多 10 个任务、20 个员工、200 节点和 200 次评估人详情请求。
