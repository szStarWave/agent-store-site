...
```json
{
  ...
  "properties": {
    ...
    "clickCountGrowthT7Max": {
      "type": "number",
      "description": "最高周点击增长率,数值范围为0-1,0.1表示10%"
    },
    "clickCountGrowthT7Min": {
      "type": "number",
      "description": "最低周点击增长率,数值范围为0-1,0.1表示10%"
    },
    "clickConversionRateMax": {
      "type": "number",
      "description": "最高点击购买转化率,数值范围为0-1,0.1表示10%"
    },
    "clickConversionRateMin": {
      "type": "number",
      "description": "最低点击购买转化率,数值范围为0-1,0.1表示10%"
    },
    "clickCountGrowthT30Max": {
      "type": "number",
      "description": "最高月点击增长率,数值范围为0-1,0.1表示10%"
    },
    "clickCountGrowthT30Min": {
      "type": "number",
      "description": "最低月点击增长率,数值范围为0-1,0.1表示10%"
    },
    "clickConversionRateCompositeMax": {
      "type": "number",
      "description": "最高综合转化率,数值范围为0-1,0.1表示10%"
    },
    "clickConversionRateCompositeMin": {
      "type": "number",
      "description": "最低综合转化率,数值范围为0-1,0.1表示10%"
    }
  }
}
```
