...
```json
{
  ...
  "properties": {
    "date": {
      "type": "string",
      "maxLength": 1000,
      "description": "查询时间。如果是 周榜，则传入 需要查询 的 那周 的周天日期，如：2025-06-15，最长近90天；如果是 ⽉榜，则传入 需要查询的月份 的 第⼀天，如： 2025-06-01，（最长 可查询近⼀年）"
    },
    "keyWord": {
      "type": "string",
      "maxLength": 50,
      "description": "商品搜索关键字(搜索关键词必须是中文，如果不是请先翻译)"
    },
    "endPrice": {
      "type": "number",
      "description": "批发价（结束）"
    ...
    "sortField": {
      "type": "string",
      "default": "orderCount",
      "pattern": "orderCount|saleCount|saleVolume|offerCreateTime|price|consignPrice",
      "examples": [
        {
          "value": "orderCount",
          "summary": "销售笔数"
    ...
    "productIds": {
      "type": "string",
      "maxLength": 1000,
      "description": "商品ID 顿号隔开搜索多个，最多20个"
    },
    "searchType": {
      "type": "integer",
      "default": 1,
    ...
    "buyerProtections": {
      ...
      "maxLength": 1000,
      "description": "权益保障，多个用“,”隔开，如：商品包邮,7天包退货,支持运费险"
    },
    "endStartQuantity": {
      "type": "integer",
      "description": "结束起批量"
