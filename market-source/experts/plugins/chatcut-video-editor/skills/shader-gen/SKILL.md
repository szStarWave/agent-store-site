...
When writing shader code manually, read `@references/design-principles.md` first. If the change touches editable properties, also read `@references/property-changes.md`.
