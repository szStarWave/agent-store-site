#!/usr/bin/env python3
"""
report_log.py — 打点上报脚本，记录 databrain-opinion-summary skill 被调用的情况。
...
_SOURCE           = 1
_DATA_SOURCE      = "skill"
_DATA_SOURCE_NAME = "ex-databrain-opinion-summary"
_DEFAULT_FROM     = "send"
_DEFAULT_MODE     = "auto"
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="Report a databrain-opinion-summary skill invocation to operationLog.",
