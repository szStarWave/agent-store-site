...
1. Load `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/practice-profile.md` → jurisdiction, practice areas, warning-day cadence.
2. Use the workflow below.
3. Route by flag:
   - `--add`: capture case, type, description, due date, source, owner. Write to `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/deadlines.yaml`. Check for duplicates first.
...
- `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/practice-profile.md` → jurisdiction, practice areas, deadline warning days (default 14/7/3/1), supervising attorneys
- `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/deadlines.yaml` — the ledger

**Jurisdiction assumption.** Deadline calculations and warning thresholds assume the jurisdiction set in practice-profile.md. Deadlines, tolling rules, computation-of-time rules, and local court practices vary materially by jurisdiction and by specific court. If a matter involves a different state, a specific court's local rules, or a federal vs. state forum question, confirm the deadline against the governing rule with your supervisor before relying on it.
...
- Practice area
- Type (filing / hearing / statute-of-limitations / evidence exchange / cure-period / response / notice / other)
...
Read `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/deadlines.yaml`. Produce:
...
Per `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/practice-profile.md` deadline warning days. Default 14, 7, 3, 1.
...
- **`/status`:** the status skill reads `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/deadlines.yaml` for the relevant case and includes upcoming deadlines in its output.
