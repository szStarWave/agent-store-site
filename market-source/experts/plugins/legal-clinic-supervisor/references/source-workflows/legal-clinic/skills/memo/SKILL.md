...
1. Load `~/.codebuddy/plugins/config/legal-workflows/legal-clinic/practice-profile.md` → practice areas, jurisdiction.
...
`~/.codebuddy/plugins/config/legal-workflows/legal-clinic/practice-profile.md` → practice areas, jurisdiction, supervision style.
...
>   witness interviewsited rent in escrow? other procedural prerequisites?]`
