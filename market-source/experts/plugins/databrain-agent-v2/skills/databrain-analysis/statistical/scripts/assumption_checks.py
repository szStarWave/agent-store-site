...
Checks: Normality, homogeneity of variance, linearity, outliers.
For BI/game analytics: revenue, DAU, retention, etc. often right-skewed;
use value_col/group_col for your metric and dimension (e.g. revenue, channel).
"""
...
if __name__ == "__main__":
    ...
    # BI example: use revenue, channel as columns
    # df_bi = pd.DataFrame({'revenue': [...], 'channel': ['Steam', 'iOS', ...]})
    # comprehensive_assumption_check(df_bi, value_col='revenue', group_col='channel', alpha=0.05)
