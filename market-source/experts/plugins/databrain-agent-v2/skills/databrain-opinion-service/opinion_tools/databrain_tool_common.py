...
from opinion_strategy.context import AgentContext as GameContext
from opinion_tools.databrain_registry import registry
...
async def set_tools_enabled_using_plan(agent_registry: Dict[str, Agent[GameContext]], game_context: GameContext):
    ...
    from opinion_strategy.constants import AgentExecutionType, AgentName
...
async def set_tools_enabled_for_agent(game_context: GameContext, agent: Agent, agent_stage_index: int, input_text: str):
    from opinion_strategy.constants import ToolName, AgentName, HandledException, UserIntention
    ...
    try:
        ...
        from opinion_utils.llm_proxy import request_tool_check_config_llm
...
def is_tool_enabled_for_current_step(context: 'RunContextWrapper[GameContext]', tool_name: str, agent_name: Optional[str] = None) -> bool:
    ...
    Usage Example:
        from opinion_tools.tool_common import is_tool_enabled_for_current_step
