...
### From Images
To derive a palette from a reference image, use any color-extraction technique (for example, k-means clustering over the image's pixels):
1. Load the image file
2. Extract dominant colors via k-means clustering
3. Map each dominant color to the nearest brand color
4. Report the compliance percentage
