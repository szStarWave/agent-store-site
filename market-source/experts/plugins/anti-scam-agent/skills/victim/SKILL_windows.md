...
```powershell
$env:AUTH_CONFIG='{"Sign":"DQsZXjYVSigaJjNXVQAPQRIEARQ2GwgQHRVDYQ9fIEEGFVc2PRw6XSw9BmksTw0LKnhTEkpCHElYLh1ENkdZBDg8WhZMK1VKEgMmEzhMSxQ6fQZ/IydYKww7ez0xMxY8FAYOQiY7WTRdGF5VGGg7VTlcOBo9R11YGiJRPEEpEQ==","CredentialId":"crd-HvjD1b3q","ResourceID":"mcp-667476b4","InstanceID":"ins-3b7b6eb8"}'
$env:MCP_CONFIG='{"McpName":"victim","McpURL":"http://lb-hcl91l4w-9x3l6p5id8zfs7h1.clb.nj-tencentclb.cloud/_llmsgw_/mcp/aga-6588cc10/mcp-667476b4"}'
...
> ⚠️ **PowerShell 通道注意事项**：本工具的 `tasks` 是 JSON 字符串，PowerShell 单次调用
> 传**包含多个复杂任务**的 `tasks=...` 时易触发 amcpcli 参数解析失败（双引号转义与
> amcpcli 的 k=v 切分冲突）。
...
$env:AUTH_CONFIG='{"Sign":"DQsZXjYVSigaJjNXVQAPQRIEARQ2GwgQHRVDYQ9fIEEGFVc2PRw6XSw9BmksTw0LKnhTEkpCHElYLh1ENkdZBDg8WhZMK1VKEgMmEzhMSxQ6fQZ/IydYKww7ez0xMxY8FAYOQiY7WTRdGF5VGGg7VTlcOBo9R11YGiJRPEEpEQ==","CredentialId":"crd-HvjD1b3q","ResourceID":"mcp-667476b4","InstanceID":"ins-3b7b6eb8"}'
$env:MCP_CONFIG='{"McpName":"victim","McpURL":"http://lb-hcl91l4w-9x3l6p5id8zfs7h1.clb.nj-tencentclb.cloud/_llmsgw_/mcp/aga-6588cc10/mcp-667476b4"}'
amcpcli.exe call victim_stats_query dimensions='["bank"]' filters='{"province":"广东省"}' start_date='2026-06-01' end_date='2026-06-30' limit=20 order_by='value_desc'
```
...
$env:AUTH_CONFIG='{"Sign":"DQsZXjYVSigaJjNXVQAPQRIEARQ2GwgQHRVDYQ9fIEEGFVc2PRw6XSw9BmksTw0LKnhTEkpCHElYLh1ENkdZBDg8WhZMK1VKEgMmEzhMSxQ6fQZ/IydYKww7ez0xMxY8FAYOQiY7WTRdGF5VGGg7VTlcOBo9R11YGiJRPEEpEQ==","CredentialId":"crd-HvjD1b3q","ResourceID":"mcp-667476b4","InstanceID":"ins-3b7b6eb8"}'
$env:MCP_CONFIG='{"McpName":"victim","McpURL":"http://lb-hcl91l4w-9x3l6p5id8zfs7h1.clb.nj-tencentclb.cloud/_llmsgw_/mcp/aga-6588cc10/mcp-667476b4"}'
amcpcli.exe call victim_realtime_alerts hours=24 top_evil_n=10 top_region_n=10
```
...
- 只允许调用 `amcpcli.exe list` 返回的 tool，严禁臆造工具名或参数。
