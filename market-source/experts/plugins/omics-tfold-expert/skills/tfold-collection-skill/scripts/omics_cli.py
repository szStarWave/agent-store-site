...
class OmicsCLI:
    ...
    def build_run(
        ...
        """
        COLLECTION_APP_ID = '807fc9ae-6197-43c0-a7a8-993c09ec1ee2'  # 合集 AppId（硬编码，禁止覆盖）
        SUB_APPS = [{"AppId": "31d80b72-6fea-44d3-9eb5-4725584199ef", "AppName": "tFold_ab_predict", "AppType": "NEXTFLOW", "AppDesc": "tFold抗体预测", "NextflowVersions": ["v24.04.3"]}, {"AppId": "864d13a9-b162-432a-bfda-7f0b6bf137e7", "AppName": "tFold_ag_predict", "AppType": "NEXTFLOW", "AppDesc": "tFold抗原预测", "NextflowVersions": ["v24.04.3"]}, {"AppId": "2286b426-09eb-47d4-9608-325651d11157", "AppName": "tFold_ag_predict_icf", "AppType": "NEXTFLOW", "AppDesc": "tFold抗原ICF预测", "NextflowVersions": ["v24.04.3"]}, {"AppId": "0ba6d880-27f1-475e-b4ec-d28885ab2b81", "AppName": "tFold_tcr_predict", "AppType": "NEXTFLOW", "AppDesc": "tFold TCR预测", "NextflowVersions": ["v24.04.3"]}]  # 子应用清单（生成时注入）
