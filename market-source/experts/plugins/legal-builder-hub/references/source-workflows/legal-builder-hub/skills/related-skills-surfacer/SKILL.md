...
1. Load `~/.codebuddy/plugins/config/legal-workflows/legal-builder-hub/practice-profile.md` → practice profile.
...
`~/.codebuddy/plugins/config/legal-workflows/legal-builder-hub/practice-profile.md` → practice profile, installed skills (don't suggest what's already installed).
...
Per `~/.codebuddy/plugins/config/legal-workflows/legal-builder-hub/practice-profile.md` → new skill notifications:
