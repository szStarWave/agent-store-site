...
Law students. 1L through exam prep.
...
Your study profile at `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` isn't static — it improves as you use the plugin. Skills tell you when an output used a default you should tune. You can re-run setup, edit the file directly, or tell a skill to record a new position.
...
- Bar prep targets your weak subjects from ~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md. It will keep coming back to them.
