...
1. Load `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → Seed materials, or an earlier section of the outline being extended), and
...
`~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → outline preferences (format, depth, existing outlines location).
