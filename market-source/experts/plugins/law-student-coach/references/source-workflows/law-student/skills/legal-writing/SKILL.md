...
1. Load `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → class, writing skill level, past feedback patterns.
...
7. Append to `~/.codebuddy/plugins/config/legal-workflows/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
Append session summary to `~/.codebuddy/plugins/config/legal-workflows/law-student/writing-feedback/[student]/tracker.md`:
