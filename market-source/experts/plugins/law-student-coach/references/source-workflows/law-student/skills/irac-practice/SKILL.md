...
1. Load `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.codebuddy/plugins/config/legal-workflows/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → current classes, exam formats, outline locations, learning style
- `~/.codebuddy/plugins/config/legal-workflows/law-student/irac-sessions/[student]/tracker.md` if exists — pattern tracking across sessions
...
Append to `~/.codebuddy/plugins/config/legal-workflows/law-student/irac-sessions/[student]/tracker.md`:
