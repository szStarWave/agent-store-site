...
1. Load `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → class list, professors, learning style.
...
- `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → current classes, professors, learning style
...
- Professor (from ~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md class list — tone and focus vary by professor)
- Class / subject area
...
**Professor-specific flavor (from ~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md notes):**
...
- **Predict jurisdiction-specific niche questions.** If the professor has known hobby horses, capture them in ~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md class notes and the skill can weight accordingly; otherwise, it works from general patterns.
