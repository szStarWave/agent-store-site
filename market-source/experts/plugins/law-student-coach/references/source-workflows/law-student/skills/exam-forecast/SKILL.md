...
1. Load `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → class, professor, exam format, syllabus.
...
7. Write `~/.codebuddy/plugins/config/legal-workflows/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Framed as weighting heuristic, not prediction.
...
- `~/.codebuddy/plugins/config/legal-workflows/law-student/practice-profile.md` → current classes, exam formats, syllabus if captured
...
Write to `~/.codebuddy/plugins/config/legal-workflows/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Versioned — if the student gets another past exam mid-semester, re-run and append.
