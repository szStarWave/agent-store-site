...
| 用途 | 路径 |
|---|---|
| 主日志 | `/data/services/pcmgr_enterprise/logs/object-server/object-server.log` |
| 错误 | `.../object-server/error_object-server.log` |
| fatal | `.../object-server/fatal_object-server.log` |

### 串联查询字段：URLType、storePath、RequestId。
