...
const LOGIN_CHANNEL = process.env.VIBEKNOW_LOGIN_CHANNEL || "workbuddy-handdraw";
// 引流双保险：把 utm 参数挂到展示给用户的验证链接上，登录页也能据此记录来源。可用 VIBEKNOW_LOGIN_UTM 覆盖。
const LOGIN_UTM = process.env.VIBEKNOW_LOGIN_UTM ?? "utm_source=workbuddy&utm_medium=handdraw";
