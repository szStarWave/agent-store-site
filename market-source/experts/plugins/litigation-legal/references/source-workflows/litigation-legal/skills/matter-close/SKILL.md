...
5. Append final entry to `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/history.md`.
6. Matter stays in `_log.yaml` and `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/` — not deleted. `/portfolio-status` filters it from active rollups.
...
- `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/matter.md` — reference (intake context)
...
**Before closing the matter (the consequential act — the matter is archived and active tracking ends):** Read `## Who's using this` in `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md`. If the Role is Non-lawyer:
...
### Append final entry to `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/history.md`
...
### Touch `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/matter.md`
