...
1. Load `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/matter.md` + `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/_log.yaml` — structured row
- `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/matter.md` — narrative intake
- `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/matters/[slug]/history.md` — event log
- `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md` — risk calibration (so "risk: high" means something specific, not generic)
...
- Any new stakeholder the matter needs (e.g., CISO becomes relevant after a evidence exchange development)?
