...
1. Load `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md` → demand-letter practice, landscape, risk calibration.
...
5. Write `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/demand-letters/[slug]/intake.md`.
...
- Desired outcome dollar value ≥ the medium-severity band from `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md` risk calibration
- Counterparty is a customer, competitor, or frequent adversary per `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md` landscape
- User ran with `--full`
...
- Research the settlement-communication protections applicable in the forum (settlement-communication rule in federal, the state equivalent otherwise). Is this letter a settlement communication that should be protected? Or an assertion of rights that shouldn't be?
...
`[type]-[counterparty-short]-[yyyy-mm]`. Confirm uniqueness in `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/demand-letters/`.

### `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/demand-letters/[slug]/intake.md`
...
[Protected or not in the forum — with reasoning. Cite primary source per the applicable rule (settlement-communication rule or state equivalent).]
...
- Run the conflicts check. If the counterparty is a customer or known entity, flag that this should clear conflicts (per `~/.codebuddy/plugins/config/legal-workflows/litigation-legal/practice-profile.md`) before sending — but the check itself lives in the matter-intake workflow or outside this skill.
