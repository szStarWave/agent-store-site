...
# -*- coding: utf-8 -*-
"""
Data Verifier Tool for Malaysia Business Intelligence Skill

Given a data point (e.g., "CPI", "133", "2024"), this tool searches both DuckDB
and Reference_Texts to verify whether the number exists in the local corpus.
