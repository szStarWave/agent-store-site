  ...
  landing: {
    ...
    showcase: {
      ...
      views: {
        chat: {
          label: "会话",
          desc: "思考过程、工具调用与回复都在同一条时间线上。每一步为什么这么做都留在记录里，一段会话结束后可以整段回看，而不是只剩最后那句回答。",
        },
        experts: {
          label: "专家",
          desc: "按场景挑选专家与专家团，看清简介与适用场景再决定，一键添加到本机。添加后即刻可用，不需要重启，也不必额外配置。",
        },
        skills: {
          label: "技能",
          desc: "按名称或来源检索技能，区分「已安装」与「可获取」。安装、启用与移除都在本机完成，来源与版本随手可查。",
        },
        connectors: {
          label: "连接器",
          desc: "浏览可以接入的外部系统，凭据是否就绪一眼就能看清。接入后即可在会话里直接调用，而凭据本身始终只留在本机。",
        },
        settings: {
          label: "设置",
          desc: "集中管理明暗主题、界面语言与 App Server 连接。端口与连接状态可见，版本信息与更新入口也在同一处。",
        },
      },
      zoom: "点击放大",
      close: "关闭",
